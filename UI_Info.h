...
enum DESIGN_MODE_ITEMS // The items of the Design Mode (you should add more items)
{
	...
	ITM_ADD_SNAKE,
	ITM_ADD_CARD,
	ITM_COPY_CARD,		//TO Copy Card
	ITM_CUT_CARD,		//To Cut Card
	ITM_Paste_Card,
	ITM_EDIT_CARD,		//To Edit Card
	ITM_DELETE_GAME_OBJECT,	//To Delete GameObject
	ITM_Save_Grid,
	ITM_OPEN_GRID, //To Open Grid
	...
	/// Add more items names here (Done)
...
enum PLAY_MODE_ITEMS // The items of the Play Mode (you should add more items)
{
	...
	ITM_ROLL_DICE,
	ITM_INPUT_DICE_VALUE,	//Input dice value
	ITM_NEW_GAME,//TO START NEW GAME
